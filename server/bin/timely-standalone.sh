...
echo "$JAVA_HOME/bin/java ${JVM_ARGS} timely.TimelyRunner "${TMP_DIR}" --spring.config.name=timely --spring.profiles.active=standalone"
$JAVA_HOME/bin/java ${JVM_ARGS} timely.TimelyRunner "${TMP_DIR}" --spring.config.name=timely --spring.profiles.active=standalone
